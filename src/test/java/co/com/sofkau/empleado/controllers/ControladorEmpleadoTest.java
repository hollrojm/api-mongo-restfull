package co.com.sofkau.empleado.controllers;

import co.com.sofkau.empleado.dtos.EmpleadoDTO;
import co.com.sofkau.empleado.services.ServicioEmpleado;
...
class ControladorEmpleadoTest {
    ...
    public void create() throws Exception {
        ...
        Mockito.when(servicioEmpleado.crear(Mockito.any())).thenReturn(datoReturn);
